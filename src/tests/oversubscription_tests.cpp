...
TEST_F(OversubscriptionTest, OverAllocationFromDecrease)
{
  ...
  Future<Resources> updateSlaveResources1;
  Future<Resources> updateSlaveResources2;
  EXPECT_CALL(allocator, updateSlave(_, _))
  ...
  EXPECT_EQ(resources, updateSlaveResources1.get());
  ...
  EXPECT_EQ(resources, Resources(offer1.resources()).revocable());
  ...
  EXPECT_EQ(resources, updateSlaveResources2.get());
  ...
  EXPECT_EQ(resources, Resources(offer2.resources()).revocable());
